...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="w-3xs flex flex-col justify-between rounded-xl shadow hover:shadow-lg transition-shadow bg-white relative">
        ...
        <div className="flex flex-col gap-1">
          <p className="text-sm text-gray-500 line-through">
            <IntlProvider locale="pt-BR">
              <FormattedNumber value={price * 1.15} style="currency" currency="BRL" />
            </IntlProvider>
          </p>
          ...
          <p className="text-sm text-gray-700">
            <IntlProvider locale="pt-BR">
              ...
              em 10x de{" "}
              <FormattedNumber value={price / 10} style="currency" currency="BRL" />
            </IntlProvider>
          </p>

          <p className="text-green-600 font-semibold text-[15px]">
            <IntlProvider locale="pt-BR">
              <FormattedNumber value={price * 0.9} style="currency" currency="BRL" />
            </IntlProvider>{" "}
            no PIX
          </p>
        </div>
